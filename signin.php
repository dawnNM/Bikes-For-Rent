		...
		<div class="span4">
			...
			<form method="post">
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" id="inputEmail1" placeholder="Email" name="email" required>
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword1">Password</label>
				<div class="controls">
				  <input type="password" class="span3"  id="inputPassword1" placeholder="Password" name="password" required>
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
...
<!-- Footer ================================================================== -->
	...
	<div class="container">
		<div class="row">
			<div class="span3">
				<h5>Contact Us</h5>
				<a href="login.html">Office Address :</a>
				<a href="login.html">723 Rue Papineau Ouest</a> 
				<a href="login.html">Montreal, Quebec</a> 
				<a href="login.html">H3P2N7, Canada</a>  
			 </div>
			<div class="span3">
				<h5>Customer Support</h5>
				<a href="register.html">Email id : info@rentabike.com</a>  
				<a href="legal_notice.html">Tel : +1 803-687-6777</a>  
				<a href="tac.html">Mobile : +1 514-677-8767</a> 
				<a href="faq.html">Fax : +1 766-877-9998</a>
			 </div>
			<div class="span3">
				<h5>OUR OFFERS</h5>
				<a href="#">New Bikes</a> 
